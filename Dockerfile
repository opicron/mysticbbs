...
RUN dpkg --add-architecture i386; apt-get update; apt-get -y install libc6:i386 wget build-essential manpages-dev unzip unrar procps mc openssl libssl-dev libpython2.7 python-pip
